...
public class PingProcessTests
{
    ...
    async public Task RunAsync_MultipleHostAddresses_True()
    {
        ...
        int expectedLineCount =
            PingOutputLikeExpression.Split(Environment.NewLine).Length * hostNames.Length;
    ...
    {
        // Test Sut.RunLongRunningAsync
        ProcessStartInfo processStartInfo = new("ping", "localhost");
        Task<int> result = Sut.RunLongRunningAsync(processStartInfo);
